            ...
            if global_step % log_every == 0:
                ...
                if logger.wandb_log is not None:
                    logger.wandb_log({
                        ...
                        "Generator/codebook_usage": codebook_loss[3],
                        "Generator/generator_adv_loss": generator_adv_loss,
                        "Generator/disc_adaptive_weight": disc_adaptive_weight,
                        "Generator/generator_disc_weight": disc_weight,
                        
                        
                        "Loss Components/rec_loss_weight": self.rec_weight,
                        "Loss Components/rec_loss": self.rec_loss,
                        "Loss Components/rec_loss_total": self.rec_weight * rec_loss,
                        "Loss Components/perc_weight": self.perceptual_weight,
                        "Loss Components/perc_loss": p_loss,
                        "Loss Components/perc_loss_total": self.perceptual_weight * p_loss,
                        "Loss Components/gen_disc_adaptive_weight": disc_adaptive_weight,
                        "Loss Components/gen_disc_weight": disc_weight,
                        "Loss Components/gen_adv_loss": generator_adv_loss,
                        "Loss Components/gen_adv_loss_total": disc_adaptive_weight * disc_weight * generator_adv_loss,
                        "Loss Components/vq_loss": codebook_loss[0],
                        "Loss Components/commit_loss": codebook_loss[1],
                        "Loss Components/entropy_loss": codebook_loss[2],
                        
                        "Loss Components/gen_total_loss = rec + perc + adv + vq + commit + entropy": loss,
            ...
            if global_step % log_every == 0:
                ...
                if logger.wandb_log is not None:
                    logger.wandb_log({
                        ...
                        "Discriminator/discriminator_disc_weight": disc_weight,
