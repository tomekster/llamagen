...
from tokenizer.tokenizer_image.vq_model import VQ_VAE_VAR_models
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vq-model", type=str, choices=list(VQ_VAE_VAR_models.keys()), default="VQ-16")
